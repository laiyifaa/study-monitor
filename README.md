...
AIGC:
  ...
  Label: '1'
  ProduceID: '0820706e-a9c4-455e-812d-59c4523c6760'
  PropagateID: '0820706e-a9c4-455e-812d-59c4523c6760'
  ReservedCode1: '9d18d01b-f983-4065-9dd3-bc05d6b9a1f1'
  ReservedCode2: '9d18d01b-f983-4065-9dd3-bc05d6b9a1f1'
---
...
- **课程-小节两级结构**：一门课包含多个小节，每个小节独立视频和开播时间
- **老师端统计看板**：班级概览 + ECharts 图表 + 学生详情列表
- **公告系统**：全平台/课程级公告，优先级标记
- **学习排行榜**：按课程展示学习时长排名
- **签到日历**：月度学习签到可视化
- **小节评价**：学生对课程小节评分和文字反馈
- **学习报告**：个人/班级/全平台三维度报告
- **小节级作业**：每个小节独立作业，支持迟交标记
...
- v3.0.0 - 课程-小节两级结构：Course 1:N Section，小节独立视频，登录快捷填入按钮
- v4.0.0 - 功能冲刺：公告/排行榜/签到日历/小节评价/学习报告/开播时间/小节作业/迟交标记/实名同步/使用指南